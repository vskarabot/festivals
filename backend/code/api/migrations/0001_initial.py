# Generated by Django 5.0.3 on 2024-05-15 09:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favourite_festivals', models.ManyToManyField(related_name='favourite_by', to='api.festival')),
                ('festivals', models.ManyToManyField(related_name='mods', to='api.festival')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(choices=[('travel', 'Travel'), ('lineup', 'Lineup'), ('tips', 'Tips'), ('shitpost', 'Shitpost')])),
                ('edited', models.BooleanField(default=False)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('festival', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='festival_posts', to='api.festival')),
                ('post_disliked_by', models.ManyToManyField(related_name='disliked_posts', to=settings.AUTH_USER_MODEL)),
                ('post_liked_by', models.ManyToManyField(related_name='liked_posts', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-time'],
            },
